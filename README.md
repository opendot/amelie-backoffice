...
This repository hosts the data visualization and backoffice frontend to be deployed on the remote server

# Amelie backoffice
This tool enables care-givers to create, manage and analyze care-receivers, depending on roles and permissions. 
- Therapists can manage users, check the evolution of care-receivers and create or modify exercises
- Parents and family care-givers can manage their care-receivers details and status
- Researchers can download anonimized data 
