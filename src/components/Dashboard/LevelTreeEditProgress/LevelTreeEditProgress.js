...
import './LevelTreeEditProgress.scss'
...
class LevelTreeEditProgress extends React.Component {
  ...
  render() {
    ...
    return (
      <div className='LevelTreeEditProgress border rounded-bottom mb-2 container-fluid'>
                          ...
                          {tree.map(exercise => (
                            <div
                              className={classNames('exercise-label', {
                                ...
                                //'force-completed': exercise.force-completed,
                                'in-progress': exercise.in_progress && !exercise.completed,
                              })}
                              key={exercise.exercise_tree.id}>
                              <div className="col-md-5 exercise-det">
                              ...
                              <div className="ml-2">
                                ...
                                <input 
                                  type="checkbox"
                                  className="switch"
                                  onChange={(e) => this.props.putExerciseTree(patient.id, exercise.exercise_tree.id, {force_completed: !exercise.completed, success: !exercise.completed, bypass_completion_checks: true}) }
                                  checked={exercise.completed}
                                  id={"completed-"+exercise.exercise_tree.id}
                                ></input>
                                  <label htmlFor={`completed-${exercise.exercise_tree.id}`}>Completato</label>
                                </span>
                              </div>
                              </div>
                            </div>
...
LevelTreeEditProgress.defaultProps = {
