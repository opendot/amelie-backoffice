...
const CareReceiversList = ({ patients, page, numPages, goToPage, filters, history, deletePatient }) => {
          ...
          <tbody>
            {patients && patients.map(patient => (
              <tr className="pointer" key={patient.id} 
                ...
                <td>{patient.city}</td>
                <td>{patient.parent && <span>{patient.parent.name} {patient.parent.surname}</span>}</td>
                <td className="w-25">
